...
// err:					the round up error
void roundVectorFields(const Eigen::MatrixXd& mesh_pts, const Eigen::MatrixXi& mesh_faces, const Eigen::MatrixXd& vecs, Eigen::MatrixXd& splitted_pts, Eigen::MatrixXi& splitted_faces, Eigen::VectorXd& theta, double global_rescaling = 1, std::vector<Eigen::Vector3d>* splitted_vecs = nullptr, std::vector<Eigen::Vector3d>* cut_pts = nullptr, std::vector<std::vector<int>>* cut_edges = nullptr, Eigen::VectorXd* err = nullptr);